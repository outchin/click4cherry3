...
public class ActivityProfile extends AppCompatActivity {
    ...
    TextView user_total_money,user_id;
    SharedPreferences mySharedPref;

    ImageView generatePDF;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String my_android_id = Secure.getString(getApplicationContext().getContentResolver(),
                Secure.ANDROID_ID);
        ...
        ic_question.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void initComponent(String my_android_id) {
        mySharedPref = getSharedPreferences(MyPREFERENCES, Context.MODE_PRIVATE);
        int previousMoney =  mySharedPref.getInt(TotalMoney,0);
        ...
        user_total_money = findViewById(R.id.user_total_money);
        user_id = findViewById(R.id.user_id);

        user_total_money.setText(previousMoney+"");
        user_id.setText(""+ my_android_id);




        ic_question = findViewById(R.id.ic_question);
    ...
    public void explainDialog() {
        LayoutInflater layoutInflaterAndroid = LayoutInflater.from(ActivityProfile.this);
        View view = layoutInflaterAndroid.inflate(R.layout.custom_dialog_explain, null);
        ((TextView) view.findViewById(R.id.txt_app_version)).setText(BuildConfig.VERSION_NAME + "");
        final AlertDialog.Builder alert = new AlertDialog.Builder(ActivityProfile.this);
        alert.setView(view);
        alert.setCancelable(false);
